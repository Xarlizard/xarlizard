...
;(function($){
	...
	$.fn.extend({
        ...
        var selectLi = $ul.parent();
                ...
                selectLi.not('.active').find(".mText_over").stop(true).animate({top:'-40px'}, 400, 'easeOutCubic');
                selectLi.not('.active').find("._overPl").stop(true).animate({top:'-40px'}, 400, 'easeInOutCubic');
