...
<h2 align="center"><b>🚀 Progetti in evidenza</b></h2>

<img src="https://raw.githubusercontent.com/cook-gpt/cook-gpt/main/.github/icon-cropped.png" width="200" alt="CookGPT" align="left"/>
<a href="https://apps.apple.com/app/id6805535867"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83" width="175" alt="Scarica su App Store" align="right"/></a>
...
<a href="https://github.com/token-bar/token-bar/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="Scarica per macOS" align="right"/></a>
...
<p>App nativa macOS per la menu bar che unifica l'uso dell'AI tra <strong>Cursor</strong>, <strong>OpenAI</strong>, <strong>Anthropic</strong> e altri — monitora tokens, credits, spesa e burn rate senza saltare tra le dashboard dei provider. Include widget Notification Center, usage alerts e storage privacy-first delle credentials nel Keychain.</p>
<p>
...
<a href="https://github.com/pocket-agent/pocket-agent-desktop-app/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="Scarica per macOS" align="right"/></a>
...
<p>Ecosistema open-source di <strong>assistente AI locale</strong> da <a href="https://github.com/pocket-agent">@pocket-agent</a> — Python <strong>Pocket Node</strong> esegue routing LLM, tools, memoria e Telegram sulla tua macchina; un'app desktop macOS impacchetta lo stack; un'API Cloudflare Worker e una web UI React gestiscono chat, monitor e impostazioni. Contratti SDK condivisi collegano ogni repo.</p>
<p>
...
<p><strong>Trascina un file. Tutti lo ricevono in diretta.</strong> Condivisione effimera di file in live-session su <strong>Cloudflare Workers</strong> — crea una room, condividi link o QR code e lascia che i peer connessi scarichino in tempo reale. Segnalazione WebSocket sull'edge; i byte viaggiano peer-to-peer nel browser. Nessun account, nessun storage persistente.</p>
<p>
<a href="https://dropafile.app-org-es.workers.dev/"><img src="https://img.shields.io/badge/Demo_live-58A6FF?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" alt="Demo live"/></a>
...
<p>Builder di firme email schema-driven con guided template flow, live HTML preview e copia con un clic in <strong>Gmail</strong>. Importa il profilo da <strong>LinkedIn</strong> per precompilare i campi e personalizza nel visual template editor — libreria di firme salvate, stile per campo e supporto multilingue inclusi.</p>
<p>
...
<h2 align="center"><b>📋 Template Open</b></h2>

<p align="center">Possiedo e mantengo <strong><a href="https://github.com/open-templates">@open-templates</a></strong> — template GitHub riutilizzabili con default sensati, init wizard e pack fullstack abbinati. Alcuni punti di ingresso:</p>

| Template | Riepilogo |
| --- | --- |
| [**github-repo-template**](https://github.com/open-templates/github-repo-template) | Shell di repo stack-agnostic — community docs, Dependabot, CODEOWNERS, template per issue e PR |
| [**npm-package-template**](https://github.com/open-templates/npm-package-template) | Pacchetto npm TypeScript production-ready — tsup, Vitest, ESLint, publish workflows & CodeQL |
| [**`.github-template`**](https://github.com/open-templates/.github-template) | Meta-repo org pubblico (`.github`) — profilo org per visitatori, catalogo repository starter, init wizard |

<p align="center">
<a href="https://github.com/open-templates"><img src="https://img.shields.io/badge/Org%20profile-open--templates-181717?style=for-the-badge&logo=github&logoColor=white" alt="Profilo org"/></a>
&nbsp;
<a href="https://github.com/orgs/open-templates/repositories"><img src="https://img.shields.io/badge/Browse-all%20templates-2088FF?style=for-the-badge&logo=github&logoColor=white" alt="Sfoglia template"/></a>
</p>

<br/><br/>

<h2 align="center"><b>📦 Librerie Open Source</b></h2>

| Pacchetto | NPM | Descrizione |
| --- | --- | --- |
| [**lizard-ui**](https://www.npmjs.com/package/lizard-ui) | <a href="https://www.npmjs.com/package/lizard-ui"><img src="https://img.shields.io/npm/v/lizard-ui?style=flat-square&logo=npm" alt="npm"/></a> | Dipendenza UI multi-tema per app React |
| [**responsive-panel**](https://www.npmjs.com/package/responsive-panel) | <a href="https://www.npmjs.com/package/responsive-panel"><img src="https://img.shields.io/npm/v/responsive-panel?style=flat-square&logo=npm" alt="npm"/></a> | Dev tool per visualizzare e testare responsive breakpoints in tempo reale |
| [**react-api-forge**](https://www.npmjs.com/package/react-api-forge) | <a href="https://www.npmjs.com/package/react-api-forge"><img src="https://img.shields.io/npm/v/react-api-forge?style=flat-square&logo=npm" alt="npm"/></a> | Type-safe React hook factory per chiamate API con loading, errors e cancellation |
| [**react-temporal**](https://www.npmjs.com/package/@xarlizard/react-temporal) | <a href="https://www.npmjs.com/package/@xarlizard/react-temporal"><img src="https://img.shields.io/npm/v/@xarlizard/react-temporal?style=flat-square&logo=npm" alt="npm"/></a> | React hooks per data e ora con la **Temporal API** JavaScript |

<br/><br/>

<h2 align="center"><b>💻 Stack Tecnologico</b></h2>
<div align="center">
<p>
...
<h2 align="center"><b>📊 Statistiche GitHub</b></h2>
<picture>
  <source
...
<h2 align="center"><b>🏆 Trofei GitHub</b></h2>
<picture>
  <source
    media="(prefers-color-scheme: dark)"
...
<h2 align="center"><b>💰 Puoi sostenermi con una donazione</b></h2>
<div align="center">
