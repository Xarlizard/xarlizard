...
<h2 align="center"><b>🚀 Uitgelichte projecten</b></h2>

<img src="https://raw.githubusercontent.com/cook-gpt/cook-gpt/main/.github/icon-cropped.png" width="200" alt="CookGPT" align="left"/>
<a href="https://apps.apple.com/app/id6805535867"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83" width="175" alt="Download in de App Store" align="right"/></a>
...
<a href="https://github.com/token-bar/token-bar/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="Download voor macOS" align="right"/></a>
...
<p>Native macOS menubalk-app die AI-gebruik bundelt over <strong>Cursor</strong>, <strong>OpenAI</strong>, <strong>Anthropic</strong> en meer — volg tokens, credits, uitgaven en verbruik zonder losse provider-dashboards. Met Notification Center-widgets, usage alerts en privacy-first opslag van credentials in de Keychain.</p>
<p>
...
<a href="https://github.com/pocket-agent/pocket-agent-desktop-app/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="Download voor macOS" align="right"/></a>
...
<p>Open-source <strong>lokale AI-assistent</strong> ecosysteem van <a href="https://github.com/pocket-agent">@pocket-agent</a> — Python <strong>Pocket Node</strong> draait LLM-routing, tools, geheugen en Telegram op je machine; een macOS desktop-app bundelt de stack; een Cloudflare Worker API en React web UI voor chat, monitor en instellingen. Gedeelde SDK-contracten verbinden elke repo.</p>
<p>
...
<p><strong>Drop een bestand. Iedereen krijgt het live.</strong> Tijdelijk live-session bestandsdelen op <strong>Cloudflare Workers</strong> — start een room, deel een link of QR-code en laat verbonden peers realtime downloaden. WebSocket-signaling aan de edge; bestandsbytes gaan peer-to-peer in de browser. Geen accounts, geen persistente opslag.</p>
<p>
<a href="https://dropafile.app-org-es.workers.dev/"><img src="https://img.shields.io/badge/Live_demo-58A6FF?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" alt="Live demo"/></a>
...
<p>Schema-gestuurde e-mailhandtekening-builder met begeleide template-flow, live HTML-preview en één-klik kopiëren naar <strong>Gmail</strong>. Importeer je <strong>LinkedIn</strong>-profiel om velden vooraf in te vullen en pas aan in de visuele template-editor — opgeslagen handtekeningenbibliotheek, per-veld styling en meertalige ondersteuning inbegrepen.</p>
<p>
...
<p align="center">Ik beheer <strong><a href="https://github.com/open-templates">@open-templates</a></strong> — herbruikbare GitHub-startersjablonen met verstandige defaults, init-wizards en gekoppelde fullstack packs. Een paar instappunten:</p>

| Template | Samenvatting |
| --- | --- |
| [**github-repo-template**](https://github.com/open-templates/github-repo-template) | Stack-agnostische repo shell — community docs, Dependabot, CODEOWNERS, issue- & PR-templates |
...
| [**`.github-template`**](https://github.com/open-templates/.github-template) | Publiek org meta-repo (`.github`) — bezoekersprofiel van de org, repository-catalogusstarter, init-wizard |

<p align="center">
<a href="https://github.com/open-templates"><img src="https://img.shields.io/badge/Org%20profile-open--templates-181717?style=for-the-badge&logo=github&logoColor=white" alt="Org-profiel"/></a>
&nbsp;
<a href="https://github.com/orgs/open-templates/repositories"><img src="https://img.shields.io/badge/Browse-all%20templates-2088FF?style=for-the-badge&logo=github&logoColor=white" alt="Templates bekijken"/></a>
</p>

<br/><br/>

<h2 align="center"><b>📦 Open Source bibliotheken</b></h2>

| Pakket | NPM | Beschrijving |
| --- | --- | --- |
| [**lizard-ui**](https://www.npmjs.com/package/lizard-ui) | <a href="https://www.npmjs.com/package/lizard-ui"><img src="https://img.shields.io/npm/v/lizard-ui?style=flat-square&logo=npm" alt="npm"/></a> | Multi-theme UI-afhankelijkheid voor React-apps |
| [**responsive-panel**](https://www.npmjs.com/package/responsive-panel) | <a href="https://www.npmjs.com/package/responsive-panel"><img src="https://img.shields.io/npm/v/responsive-panel?style=flat-square&logo=npm" alt="npm"/></a> | Dev-tool om responsive breakpoints in realtime te visualiseren en testen |
| [**react-api-forge**](https://www.npmjs.com/package/react-api-forge) | <a href="https://www.npmjs.com/package/react-api-forge"><img src="https://img.shields.io/npm/v/react-api-forge?style=flat-square&logo=npm" alt="npm"/></a> | Type-safe React hook factory voor API-calls met loading, errors en annulering |
| [**react-temporal**](https://www.npmjs.com/package/@xarlizard/react-temporal) | <a href="https://www.npmjs.com/package/@xarlizard/react-temporal"><img src="https://img.shields.io/npm/v/@xarlizard/react-temporal?style=flat-square&logo=npm" alt="npm"/></a> | React hooks voor datum en tijd met de JavaScript **Temporal API** |
...
<h2 align="center"><b>📊 GitHub-statistieken</b></h2>
<picture>
  <source
...
<h2 align="center"><b>🏆 GitHub-trofeeën</b></h2>
<picture>
  <source
    media="(prefers-color-scheme: dark)"
...
<h2 align="center"><b>💰 Je kunt me steunen met een donatie</b></h2>
<div align="center">
