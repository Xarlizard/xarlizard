...
<p>App nativa open-source en <strong>SwiftUI</strong> de <a href="https://github.com/cook-gpt">@cook-gpt</a> — explora y edita recetas, planifica comidas por día o semana, genera listas de la compra desde tu calendario y usa temporizadores de pasos con <strong>Live Activities</strong> en la pantalla de bloqueo y la Dynamic Island. Tus recetas, planes de comidas y listas de compra permanecen en el dispositivo.</p>
<p>
...
<p>App nativa de macOS para la barra de menú que unifica el uso de IA entre <strong>Cursor</strong>, <strong>OpenAI</strong>, <strong>Anthropic</strong> y más — controla tokens, créditos, gasto y ritmo de consumo sin abrir paneles de cada proveedor. Incluye widgets del Centro de notificaciones, alertas de uso y credenciales en el Keychain con enfoque privacy-first.</p>
<p>
...
<p><strong>Suelta un archivo. Todos lo reciben en vivo.</strong> Compartición efímera de archivos en sesión en vivo con <strong>Cloudflare Workers</strong> — crea una sala, comparte un enlace o código QR y deja que los pares conectados descarguen en tiempo real. Señalización WebSocket en el edge; los bytes viajan peer-to-peer en el navegador. Sin cuentas ni almacenamiento persistente.</p>
<p>
<a href="https://dropafile.app-org-es.workers.dev/"><img src="https://img.shields.io/badge/Demo_en_vivo-58A6FF?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" alt="Demo en vivo"/></a>
...
<p>Constructor de firmas de email basado en esquemas, con flujo guiado, vista previa HTML en vivo y copia en un clic a <strong>Gmail</strong>. Importa tu perfil de <strong>LinkedIn</strong> para rellenar campos y personaliza en el editor visual — biblioteca de firmas, estilos por campo y soporte multiidioma incluidos.</p>
<p>
...
<h2 align="center"><b>📋 Plantillas Open</b></h2>

<p align="center">Soy dueño y mantenedor de <strong><a href="https://github.com/open-templates">@open-templates</a></strong> — plantillas GitHub reutilizables con valores sensatos, asistentes de inicio y packs fullstack emparejados. Algunos puntos de entrada:</p>

| Plantilla | Resumen |
| --- | --- |
| [**github-repo-template**](https://github.com/open-templates/github-repo-template) | Shell de repo agnóstico al stack — docs de comunidad, Dependabot, CODEOWNERS, plantillas de issues y PR |
| [**npm-package-template**](https://github.com/open-templates/npm-package-template) | Paquete npm TypeScript listo para producción — tsup, Vitest, ESLint, flujos de publicación y CodeQL |
| [**`.github-template`**](https://github.com/open-templates/.github-template) | Meta-repo público de org (`.github`) — perfil de org para visitantes, catálogo de repos inicial, asistente de init |

<p align="center">
<a href="https://github.com/open-templates"><img src="https://img.shields.io/badge/Org%20profile-open--templates-181717?style=for-the-badge&logo=github&logoColor=white" alt="Perfil de org"/></a>
&nbsp;
<a href="https://github.com/orgs/open-templates/repositories"><img src="https://img.shields.io/badge/Browse-all%20templates-2088FF?style=for-the-badge&logo=github&logoColor=white" alt="Explorar plantillas"/></a>
</p>
...
| --- | --- | --- |
| [**lizard-ui**](https://www.npmjs.com/package/lizard-ui) | <a href="https://www.npmjs.com/package/lizard-ui"><img src="https://img.shields.io/npm/v/lizard-ui?style=flat-square&logo=npm" alt="npm"/></a> | Dependencia UI multi-tema para apps React |
| [**responsive-panel**](https://www.npmjs.com/package/responsive-panel) | <a href="https://www.npmjs.com/package/responsive-panel"><img src="https://img.shields.io/npm/v/responsive-panel?style=flat-square&logo=npm" alt="npm"/></a> | Herramienta para visualizar y probar breakpoints responsive en tiempo real |
| [**react-api-forge**](https://www.npmjs.com/package/react-api-forge) | <a href="https://www.npmjs.com/package/react-api-forge"><img src="https://img.shields.io/npm/v/react-api-forge?style=flat-square&logo=npm" alt="npm"/></a> | Factory de hooks React type-safe para APIs con loading, errores y cancelación |
| [**react-temporal**](https://www.npmjs.com/package/@xarlizard/react-temporal) | <a href="https://www.npmjs.com/package/@xarlizard/react-temporal"><img src="https://img.shields.io/npm/v/@xarlizard/react-temporal?style=flat-square&logo=npm" alt="npm"/></a> | Hooks React para fecha y hora con la **Temporal API** de JavaScript |
...
<h2 align="center"><b>📊 Estadísticas de GitHub</b></h2>
<picture>
  <source
...
<h2 align="center"><b>🏆 Trofeos de GitHub</b></h2>
<picture>
  <source
    media="(prefers-color-scheme: dark)"
...
<h2 align="center"><b>💰 Puedes apoyarme con una donación</b></h2>
<div align="center">
