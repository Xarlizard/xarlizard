...
<h2 align="center"><b>🚀 مشاريع مميزة</b></h2>

<img src="https://raw.githubusercontent.com/cook-gpt/cook-gpt/main/.github/icon-cropped.png" width="200" alt="CookGPT" align="left"/>
<a href="https://apps.apple.com/app/id6805535867"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83" width="175" alt="التنزيل من App Store" align="right"/></a>
...
<a href="https://github.com/token-bar/token-bar/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="تنزيل لـ macOS" align="right"/></a>
...
<p>
<a href="https://dropafile.app-org-es.workers.dev/"><img src="https://img.shields.io/badge/%D8%B9%D8%B1%D8%B6_%D9%85%D8%A8%D8%A7%D8%B4%D8%B1-58A6FF?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" alt="عرض مباشر"/></a>
...
<p>منشئ توقيعات email قائم على schema مع guided template flow و live HTML preview ونسخ بنقرة واحدة إلى <strong>Gmail</strong>. استورد ملفك من <strong>LinkedIn</strong> لملء الحقول مسبقًا، ثم خصص في visual template editor — مكتبة توقيعات محفوظة وتنسيق لكل حقل ودعم متعدد اللغات.</p>
<p>
...
<p align="center">أملك وأدير <strong><a href="https://github.com/open-templates">@open-templates</a></strong> — قوالب GitHub قابلة لإعادة الاستخدام مع defaults معقولة ومعالجات init وحزم fullstack مزدوجة. بعض نقاط الدخول:</p>

| القالب | ملخص |
| --- | --- |
| [**github-repo-template**](https://github.com/open-templates/github-repo-template) | قشرة repo مستقلة عن الـ stack — community docs وDependabot وCODEOWNERS وقوالب issues وPR |
| [**npm-package-template**](https://github.com/open-templates/npm-package-template) | حزمة npm TypeScript جاهزة للإنتاج — tsup وVitest وESLint وpublish workflows وCodeQL |
| [**`.github-template`**](https://github.com/open-templates/.github-template) | مستودع meta عام للمنظمة (`.github`) — ملف org للزوار وكاتالوج repos أولي ومعالج init |

<p align="center">
<a href="https://github.com/open-templates"><img src="https://img.shields.io/badge/Org%20profile-open--templates-181717?style=for-the-badge&logo=github&logoColor=white" alt="ملف المنظمة"/></a>
&nbsp;
<a href="https://github.com/orgs/open-templates/repositories"><img src="https://img.shields.io/badge/Browse-all%20templates-2088FF?style=for-the-badge&logo=github&logoColor=white" alt="تصفح القوالب"/></a>
</p>
...
| الحزمة | NPM | الوصف |
| --- | --- | --- |
| [**lizard-ui**](https://www.npmjs.com/package/lizard-ui) | <a href="https://www.npmjs.com/package/lizard-ui"><img src="https://img.shields.io/npm/v/lizard-ui?style=flat-square&logo=npm" alt="npm"/></a> | اعتماد UI متعدد السمات لبناء تطبيقات React |
...
<h2 align="center"><b>💻 مجموعة التقنيات</b></h2>
<div align="center">
<p>
...
<h2 align="center"><b>📊 إحصائيات GitHub</b></h2>
<picture>
  <source
...
<h2 align="center"><b>🏆 جوائز GitHub</b></h2>
<picture>
  <source
    media="(prefers-color-scheme: dark)"
...
<h2 align="center"><b>💰 يمكنك دعمي بالتبرع</b></h2>
<div align="center">
