...
<h2 align="center"><b>🚀 Projectes destacats</b></h2>

<img src="https://raw.githubusercontent.com/cook-gpt/cook-gpt/main/.github/icon-cropped.png" width="200" alt="CookGPT" align="left"/>
<a href="https://apps.apple.com/app/id6805535867"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83" width="175" alt="Descarregar a l'App Store" align="right"/></a>
...
<a href="https://github.com/token-bar/token-bar/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="Descarregar per a macOS" align="right"/></a>
...
<p>
<a href="https://dropafile.app-org-es.workers.dev/"><img src="https://img.shields.io/badge/Demo_en_directe-58A6FF?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" alt="Demo en directe"/></a>
...
<p>Constructor de signatures de correu basat en esquemes, amb flux guiat, vista prèvia HTML en viu i còpia en un clic a <strong>Gmail</strong>. Importa el perfil de <strong>LinkedIn</strong> per omplir camps i personalitza a l'editor visual — biblioteca de signatures, estils per camp i suport multilingüe inclosos.</p>
<p>
...
<h2 align="center"><b>📋 Plantilles Open</b></h2>

<p align="center">Soc propietari i mantinc <strong><a href="https://github.com/open-templates">@open-templates</a></strong> — plantilles GitHub reutilitzables amb defaults sensats, assistents d'inici i packs fullstack aparellats. Alguns punts d'entrada:</p>

| Plantilla | Resum |
| --- | --- |
| [**github-repo-template**](https://github.com/open-templates/github-repo-template) | Shell de repo agnòstic al stack — docs de comunitat, Dependabot, CODEOWNERS, plantilles d'issues i PR |
| [**npm-package-template**](https://github.com/open-templates/npm-package-template) | Paquet npm TypeScript llest per a producció — tsup, Vitest, ESLint, publish workflows & CodeQL |
| [**`.github-template`**](https://github.com/open-templates/.github-template) | Meta-repo públic d'org (`.github`) — perfil d'org per a visitants, catàleg de repos inicial, assistent d'init |

<p align="center">
<a href="https://github.com/open-templates"><img src="https://img.shields.io/badge/Org%20profile-open--templates-181717?style=for-the-badge&logo=github&logoColor=white" alt="Perfil d'org"/></a>
&nbsp;
<a href="https://github.com/orgs/open-templates/repositories"><img src="https://img.shields.io/badge/Browse-all%20templates-2088FF?style=for-the-badge&logo=github&logoColor=white" alt="Explorar plantilles"/></a>
</p>

<br/><br/>

<h2 align="center"><b>📦 Biblioteques Open Source</b></h2>

| Paquet | NPM | Descripció |
| --- | --- | --- |
| [**lizard-ui**](https://www.npmjs.com/package/lizard-ui) | <a href="https://www.npmjs.com/package/lizard-ui"><img src="https://img.shields.io/npm/v/lizard-ui?style=flat-square&logo=npm" alt="npm"/></a> | Dependència UI multi-tema per a apps React |
| [**responsive-panel**](https://www.npmjs.com/package/responsive-panel) | <a href="https://www.npmjs.com/package/responsive-panel"><img src="https://img.shields.io/npm/v/responsive-panel?style=flat-square&logo=npm" alt="npm"/></a> | Eina de dev per visualitzar i provar breakpoints responsive en temps real |
| [**react-api-forge**](https://www.npmjs.com/package/react-api-forge) | <a href="https://www.npmjs.com/package/react-api-forge"><img src="https://img.shields.io/npm/v/react-api-forge?style=flat-square&logo=npm" alt="npm"/></a> | Factory de hooks React type-safe per a APIs amb loading, errors i cancel·lació |
| [**react-temporal**](https://www.npmjs.com/package/@xarlizard/react-temporal) | <a href="https://www.npmjs.com/package/@xarlizard/react-temporal"><img src="https://img.shields.io/npm/v/@xarlizard/react-temporal?style=flat-square&logo=npm" alt="npm"/></a> | Hooks React per a data i hora amb la **Temporal API** de JavaScript |

<br/><br/>

<h2 align="center"><b>💻 Stack Tecnològic</b></h2>
<div align="center">
<p>
...
<h2 align="center"><b>📊 Estadístiques de GitHub</b></h2>
<picture>
  <source
...
<h2 align="center"><b>🏆 Trofeus de GitHub</b></h2>
<picture>
  <source
    media="(prefers-color-scheme: dark)"
...
<h2 align="center"><b>💰 Pots donar-me suport amb una donació</b></h2>
<div align="center">
