...
<p>Open-source нативное приложение на <strong>SwiftUI</strong> от <a href="https://github.com/cook-gpt">@cook-gpt</a> — просматривайте и редактируйте рецепты, планируйте приёмы пищи по дням или неделям, создавайте списки покупок из расписания и запускайте таймеры шагов с <strong>Live Activities</strong> на экране блокировки и Dynamic Island. Рецепты, планы питания и списки покупок остаются на устройстве.</p>
<p>
...
<p>
<a href="https://dropafile.app-org-es.workers.dev/"><img src="https://img.shields.io/badge/%D0%96%D0%B8%D0%B2%D0%BE%D0%B5_%D0%B4%D0%B5%D0%BC%D0%BE-58A6FF?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" alt="Живое демо"/></a>
...
<p>Schema-driven конструктор email-подписей с guided template flow, live HTML preview и копированием в <strong>Gmail</strong> в один клик. Импортируйте профиль из <strong>LinkedIn</strong> для автозаполнения полей и настраивайте в визуальном template editor — библиотека подписей, стилизация по полям и мультиязычная поддержка включены.</p>
<p>
...
<p align="center">Я владею и поддерживаю <strong><a href="https://github.com/open-templates">@open-templates</a></strong> — переиспользуемые GitHub-шаблоны с разумными defaults, init-wizards и парными fullstack-паками. Несколько точек входа:</p>

| Шаблон | Кратко |
| --- | --- |
| [**github-repo-template**](https://github.com/open-templates/github-repo-template) | Stack-agnostic repo shell — community docs, Dependabot, CODEOWNERS, шаблоны issues и PR |
...
| [**`.github-template`**](https://github.com/open-templates/.github-template) | Публичный org meta-repo (`.github`) — профиль org для посетителей, стартовый каталог репозиториев, init wizard |

<p align="center">
<a href="https://github.com/open-templates"><img src="https://img.shields.io/badge/Org%20profile-open--templates-181717?style=for-the-badge&logo=github&logoColor=white" alt="Профиль org"/></a>
&nbsp;
<a href="https://github.com/orgs/open-templates/repositories"><img src="https://img.shields.io/badge/Browse-all%20templates-2088FF?style=for-the-badge&logo=github&logoColor=white" alt="Смотреть шаблоны"/></a>
</p>

<br/><br/>

<h2 align="center"><b>📦 Open Source библиотеки</b></h2>

| Пакет | NPM | Описание |
| --- | --- | --- |
| [**lizard-ui**](https://www.npmjs.com/package/lizard-ui) | <a href="https://www.npmjs.com/package/lizard-ui"><img src="https://img.shields.io/npm/v/lizard-ui?style=flat-square&logo=npm" alt="npm"/></a> | Multi-theme UI-зависимость для React-приложений |
| [**responsive-panel**](https://www.npmjs.com/package/responsive-panel) | <a href="https://www.npmjs.com/package/responsive-panel"><img src="https://img.shields.io/npm/v/responsive-panel?style=flat-square&logo=npm" alt="npm"/></a> | Dev tool для визуализации и тестирования responsive breakpoints в реальном времени |
| [**react-api-forge**](https://www.npmjs.com/package/react-api-forge) | <a href="https://www.npmjs.com/package/react-api-forge"><img src="https://img.shields.io/npm/v/react-api-forge?style=flat-square&logo=npm" alt="npm"/></a> | Type-safe React hook factory для API-вызовов с loading, errors и cancellation |
| [**react-temporal**](https://www.npmjs.com/package/@xarlizard/react-temporal) | <a href="https://www.npmjs.com/package/@xarlizard/react-temporal"><img src="https://img.shields.io/npm/v/@xarlizard/react-temporal?style=flat-square&logo=npm" alt="npm"/></a> | React hooks для даты и времени с JavaScript **Temporal API** |

<br/><br/>

<h2 align="center"><b>💻 Технологический стек</b></h2>
<div align="center">
<p>
...
<h2 align="center"><b>📊 Статистика GitHub</b></h2>
<picture>
  <source
...
<h2 align="center"><b>🏆 Трофеи GitHub</b></h2>
<picture>
  <source
    media="(prefers-color-scheme: dark)"
...
<h2 align="center"><b>💰 Вы можете поддержать меня донатом</b></h2>
<div align="center">
