...
<h2 align="center"><b>🚀 Projetos em destaque</b></h2>

<img src="https://raw.githubusercontent.com/cook-gpt/cook-gpt/main/.github/icon-cropped.png" width="200" alt="CookGPT" align="left"/>
<a href="https://apps.apple.com/app/id6805535867"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83" width="175" alt="Transferir na App Store" align="right"/></a>
...
<a href="https://github.com/token-bar/token-bar/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="Transferir para macOS" align="right"/></a>
...
<p>App nativa macOS para a barra de menus que unifica o uso de IA entre <strong>Cursor</strong>, <strong>OpenAI</strong>, <strong>Anthropic</strong> e mais — acompanhe tokens, credits, gastos e burn rate sem alternar entre dashboards de providers. Inclui widgets do Notification Center, usage alerts e armazenamento privacy-first de credentials no Keychain.</p>
<p>
...
<a href="https://github.com/pocket-agent/pocket-agent-desktop-app/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="Transferir para macOS" align="right"/></a>
...
<p>Ecossistema open-source de <strong>assistente de IA local</strong> da <a href="https://github.com/pocket-agent">@pocket-agent</a> — Python <strong>Pocket Node</strong> executa roteamento LLM, ferramentas, memória e Telegram na sua máquina; uma app desktop macOS empacota o stack; uma API Cloudflare Worker e web UI React gerem chat, monitor e definições. Contratos SDK partilhados ligam cada repositório.</p>
<p>
...
<p><strong>Largue um ficheiro. Todos recebem em direto.</strong> Partilha efémera de ficheiros em sessão live em <strong>Cloudflare Workers</strong> — crie uma sala, partilhe um link ou código QR e deixe os peers ligados descarregar em tempo real. Sinalização WebSocket na edge; os bytes fluem peer-to-peer no browser. Sem contas nem armazenamento persistente.</p>
<p>
<a href="https://dropafile.app-org-es.workers.dev/"><img src="https://img.shields.io/badge/Demo_ao_vivo-58A6FF?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" alt="Demo ao vivo"/></a>
...
<p>Construtor de assinaturas de email schema-driven com guided template flow, live HTML preview e cópia num clique para <strong>Gmail</strong>. Importe o perfil do <strong>LinkedIn</strong> para preencher campos e personalize no visual template editor — biblioteca de assinaturas, estilo por campo e suporte multilingue incluídos.</p>
<p>
...
<h2 align="center"><b>📋 Templates Open</b></h2>

<p align="center">Sou dono e mantenedor de <strong><a href="https://github.com/open-templates">@open-templates</a></strong> — templates GitHub reutilizáveis com defaults sensatos, init wizards e packs fullstack emparelhados. Alguns pontos de entrada:</p>

| Template | Resumo |
| --- | --- |
| [**github-repo-template**](https://github.com/open-templates/github-repo-template) | Shell de repo agnóstico ao stack — community docs, Dependabot, CODEOWNERS, templates de issues e PR |
| [**npm-package-template**](https://github.com/open-templates/npm-package-template) | Pacote npm TypeScript production-ready — tsup, Vitest, ESLint, publish workflows & CodeQL |
| [**`.github-template`**](https://github.com/open-templates/.github-template) | Meta-repo público de org (`.github`) — perfil de org para visitantes, catálogo de repositórios starter, init wizard |

<p align="center">
<a href="https://github.com/open-templates"><img src="https://img.shields.io/badge/Org%20profile-open--templates-181717?style=for-the-badge&logo=github&logoColor=white" alt="Perfil da org"/></a>
&nbsp;
<a href="https://github.com/orgs/open-templates/repositories"><img src="https://img.shields.io/badge/Browse-all%20templates-2088FF?style=for-the-badge&logo=github&logoColor=white" alt="Explorar templates"/></a>
</p>

<br/><br/>

<h2 align="center"><b>📦 Bibliotecas Open Source</b></h2>

| Pacote | NPM | Descrição |
| --- | --- | --- |
| [**lizard-ui**](https://www.npmjs.com/package/lizard-ui) | <a href="https://www.npmjs.com/package/lizard-ui"><img src="https://img.shields.io/npm/v/lizard-ui?style=flat-square&logo=npm" alt="npm"/></a> | Dependência UI multi-tema para apps React |
| [**responsive-panel**](https://www.npmjs.com/package/responsive-panel) | <a href="https://www.npmjs.com/package/responsive-panel"><img src="https://img.shields.io/npm/v/responsive-panel?style=flat-square&logo=npm" alt="npm"/></a> | Dev tool para visualizar e testar responsive breakpoints em tempo real |
| [**react-api-forge**](https://www.npmjs.com/package/react-api-forge) | <a href="https://www.npmjs.com/package/react-api-forge"><img src="https://img.shields.io/npm/v/react-api-forge?style=flat-square&logo=npm" alt="npm"/></a> | Type-safe React hook factory para chamadas API com loading, errors e cancellation |
| [**react-temporal**](https://www.npmjs.com/package/@xarlizard/react-temporal) | <a href="https://www.npmjs.com/package/@xarlizard/react-temporal"><img src="https://img.shields.io/npm/v/@xarlizard/react-temporal?style=flat-square&logo=npm" alt="npm"/></a> | React hooks para data e hora com a **Temporal API** JavaScript |

<br/><br/>

<h2 align="center"><b>💻 Stack Tecnológico</b></h2>
<div align="center">
<p>
...
<h2 align="center"><b>📊 Estatísticas do GitHub</b></h2>
<picture>
  <source
...
<h2 align="center"><b>🏆 Troféus do GitHub</b></h2>
<picture>
  <source
    media="(prefers-color-scheme: dark)"
...
<h2 align="center"><b>💰 Pode apoiar-me com uma doação</b></h2>
<div align="center">
