...
<h2 align="center"><b>🚀 פרויקטים נבחרים</b></h2>

<img src="https://raw.githubusercontent.com/cook-gpt/cook-gpt/main/.github/icon-cropped.png" width="200" alt="CookGPT" align="left"/>
<a href="https://apps.apple.com/app/id6805535867"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83" width="175" alt="הורדה מ-App Store" align="right"/></a>
...
<a href="https://github.com/token-bar/token-bar/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="הורדה ל-macOS" align="right"/></a>
...
<p>אפליקציית macOS native לשורת התפריט שמאחדת שימוש ב-AI ב<strong>Cursor</strong>, <strong>OpenAI</strong>, <strong>Anthropic</strong> ועוד — מעקב אחר tokens, credits, הוצאות וקצב שריפה בלי לקפוץ בין דשבורדים של ספקים. כולל ווידג'טים ב-Notification Center, התראות שימוש ואחסון credentials ממוקד פרטיות ב-Keychain.</p>
<p>
...
<a href="https://github.com/pocket-agent/pocket-agent-desktop-app/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="הורדה ל-macOS" align="right"/></a>
...
<p>מערכת אקולוגית של <strong>עוזר AI מקומי</strong> בקוד פתוח מ-<a href="https://github.com/pocket-agent">@pocket-agent</a> — Python <strong>Pocket Node</strong> מריץ ניתוב LLM, כלים, זיכרון ו-Telegram על המכונה שלך; אפליקציית macOS שולחנית אורזת את ה-stack; API של Cloudflare Worker וממשק React לצ'אט, ניטור והגדרות. חוזי SDK משותפים מחברים כל repo.</p>
<p>
...
<p><strong>שחררו קובץ. כולם מקבלים אותו בשידור חי.</strong> שיתוף קבצים אפמרלי ב-live-session על <strong>Cloudflare Workers</strong> — צרו חדר, שתפו קישור או QR code, ותנו ל-peers מחוברים להוריד בזמן אמת. אותות WebSocket ב-edge; בתי הקובץ זורמים peer-to-peer בדפדפן. ללא חשבונות וללא אחסון קבוע.</p>
<p>
<a href="https://dropafile.app-org-es.workers.dev/"><img src="https://img.shields.io/badge/%D7%94%D7%93%D7%92%D7%9E%D7%94_%D7%97%D7%99%D7%94-58A6FF?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" alt="הדגמה חיה"/></a>
...
<p>בונה חתימות אימייל מונחה schema עם זרימת תבנית מודרכת, תצוגה מקדימה HTML חיה והעתקה בלחיצה אחת ל<strong>Gmail</strong>. ייבוא פרופיל מ<strong>LinkedIn</strong> למילוי שדות, ואז התאמה בעורך תבניות ויזואלי — ספריית חתימות שמורות, עיצוב לפי שדה ותמיכה רב-לשונית.</p>
<p>
...
<h2 align="center"><b>📋 תבניות Open</b></h2>

<p align="center">אני הבעלים והמתחזק של <strong><a href="https://github.com/open-templates">@open-templates</a></strong> — תבניות GitHub לשימוש חוזר עם defaults הגיוניים, אשפי init וחבילות fullstack מזווגות. כמה נקודות כניסה:</p>

| תבנית | תקציר |
| --- | --- |
| [**github-repo-template**](https://github.com/open-templates/github-repo-template) | מעטפת repo שאינה תלויה ב-stack — community docs, Dependabot, CODEOWNERS, תבניות issue ו-PR |
| [**npm-package-template**](https://github.com/open-templates/npm-package-template) | חבילת npm TypeScript מוכנה לפרודקשן — tsup, Vitest, ESLint, publish workflows ו-CodeQL |
| [**`.github-template`**](https://github.com/open-templates/.github-template) | מטא-repo ציבורי של org (`.github`) — פרופיל org לצופים, קטלוג repos התחלתי, אשף init |

<p align="center">
<a href="https://github.com/open-templates"><img src="https://img.shields.io/badge/Org%20profile-open--templates-181717?style=for-the-badge&logo=github&logoColor=white" alt="פרופיל org"/></a>
&nbsp;
<a href="https://github.com/orgs/open-templates/repositories"><img src="https://img.shields.io/badge/Browse-all%20templates-2088FF?style=for-the-badge&logo=github&logoColor=white" alt="עיון בתבניות"/></a>
</p>

<br/><br/>

<h2 align="center"><b>📦 ספריות קוד פתוח</b></h2>

| חבילה | NPM | תיאור |
| --- | --- | --- |
| [**lizard-ui**](https://www.npmjs.com/package/lizard-ui) | <a href="https://www.npmjs.com/package/lizard-ui"><img src="https://img.shields.io/npm/v/lizard-ui?style=flat-square&logo=npm" alt="npm"/></a> | תלות UI רב-ערכת נושא לבניית אפליקציות React |
| [**responsive-panel**](https://www.npmjs.com/package/responsive-panel) | <a href="https://www.npmjs.com/package/responsive-panel"><img src="https://img.shields.io/npm/v/responsive-panel?style=flat-square&logo=npm" alt="npm"/></a> | כלי פיתוח להצגה ובדיקה של responsive breakpoints בזמן אמת |
| [**react-api-forge**](https://www.npmjs.com/package/react-api-forge) | <a href="https://www.npmjs.com/package/react-api-forge"><img src="https://img.shields.io/npm/v/react-api-forge?style=flat-square&logo=npm" alt="npm"/></a> | מפעל React hooks type-safe לקריאות API עם loading, שגיאות וביטול |
| [**react-temporal**](https://www.npmjs.com/package/@xarlizard/react-temporal) | <a href="https://www.npmjs.com/package/@xarlizard/react-temporal"><img src="https://img.shields.io/npm/v/@xarlizard/react-temporal?style=flat-square&logo=npm" alt="npm"/></a> | React hooks לתאריך ושעה באמצעות **Temporal API** של JavaScript |

<br/><br/>

<h2 align="center"><b>💻 מחסנית טכנולוגית</b></h2>
<div align="center">
<p>
...
<h2 align="center"><b>📊 סטטיסטיקות GitHub</b></h2>
<picture>
  <source
...
<h2 align="center"><b>🏆 גביעי GitHub</b></h2>
<picture>
  <source
    media="(prefers-color-scheme: dark)"
...
<h2 align="center"><b>💰 אפשר לעזור לי בתרומה</b></h2>
<div align="center">
