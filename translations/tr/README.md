...
<h2 align="center"><b>🚀 Öne Çıkan Projeler</b></h2>

<img src="https://raw.githubusercontent.com/cook-gpt/cook-gpt/main/.github/icon-cropped.png" width="200" alt="CookGPT" align="left"/>
<a href="https://apps.apple.com/app/id6805535867"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83" width="175" alt="App Store'dan indir" align="right"/></a>
...
<a href="https://github.com/token-bar/token-bar/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="macOS için indir" align="right"/></a>
...
<p>Menü çubuğu için native macOS uygulaması; <strong>Cursor</strong>, <strong>OpenAI</strong>, <strong>Anthropic</strong> ve daha fazlasında AI kullanımını birleştirir — sağlayıcı panoları arasında geçiş yapmadan token, kredi, harcama ve tüketim hızını takip edin. Notification Center widget'ları, kullanım uyarıları ve Keychain'de gizlilik odaklı kimlik bilgisi depolama içerir.</p>
<p>
...
<a href="https://github.com/pocket-agent/pocket-agent-desktop-app/releases"><img src="https://raw.githubusercontent.com/token-bar/token-bar/main/.github/macos_badge_noborder.png" width="175" alt="macOS için indir" align="right"/></a>
...
<p><a href="https://github.com/pocket-agent">@pocket-agent</a> kaynaklı açık kaynak <strong>yerel AI asistanı</strong> ekosistemi — Python <strong>Pocket Node</strong> makinenizde LLM yönlendirme, araçlar, bellek ve Telegram çalıştırır; macOS masaüstü uygulaması yığını paketler; Cloudflare Worker API ve React web UI sohbet, izleme ve ayarları yönetir. Paylaşılan SDK sözleşmeleri her repoyu birbirine bağlar.</p>
<p>
...
<p><strong>Bir dosya bırakın. Herkes canlı alır.</strong> <strong>Cloudflare Workers</strong> üzerinde geçici live-session dosya paylaşımı — bir oda açın, bağlantı veya QR kodu paylaşın, bağlı eşler gerçek zamanlı indirsin. Edge'de WebSocket sinyalleme; dosya baytları tarayıcıda peer-to-peer akar. Hesap yok, kalıcı depolama yok.</p>
<p>
<a href="https://dropafile.app-org-es.workers.dev/"><img src="https://img.shields.io/badge/Canl%C4%B1_demo-58A6FF?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" alt="Canlı demo"/></a>
...
<h2 align="center"><b>📋 Açık Şablonlar</b></h2>

<p align="center"><strong><a href="https://github.com/open-templates">@open-templates</a></strong>'in sahibi ve bakımcısıyım — mantıklı varsayılanlar, init sihirbazları ve eşleştirilmiş fullstack paketleriyle yeniden kullanılabilir GitHub başlangıç şablonları. Birkaç giriş noktası:</p>

| Şablon | Özet |
| --- | --- |
| [**github-repo-template**](https://github.com/open-templates/github-repo-template) | Stack-agnostic repo shell — community docs, Dependabot, CODEOWNERS, issue ve PR şablonları |
| [**npm-package-template**](https://github.com/open-templates/npm-package-template) | Production-ready TypeScript npm package — tsup, Vitest, ESLint, publish workflows & CodeQL |
| [**`.github-template`**](https://github.com/open-templates/.github-template) | Herkese açık org meta-repo (`.github`) — ziyaretçilere yönelik org profili, depo kataloğu starter, init sihirbazı |

<p align="center">
<a href="https://github.com/open-templates"><img src="https://img.shields.io/badge/Org%20profile-open--templates-181717?style=for-the-badge&logo=github&logoColor=white" alt="Org profili"/></a>
&nbsp;
<a href="https://github.com/orgs/open-templates/repositories"><img src="https://img.shields.io/badge/Browse-all%20templates-2088FF?style=for-the-badge&logo=github&logoColor=white" alt="Şablonlara göz at"/></a>
</p>

<br/><br/>

<h2 align="center"><b>📦 Açık Kaynak Kütüphaneler</b></h2>

| Paket | NPM | Açıklama |
| --- | --- | --- |
| [**lizard-ui**](https://www.npmjs.com/package/lizard-ui) | <a href="https://www.npmjs.com/package/lizard-ui"><img src="https://img.shields.io/npm/v/lizard-ui?style=flat-square&logo=npm" alt="npm"/></a> | React uygulamaları oluşturmak için çok temalı UI bağımlılığı |
| [**responsive-panel**](https://www.npmjs.com/package/responsive-panel) | <a href="https://www.npmjs.com/package/responsive-panel"><img src="https://img.shields.io/npm/v/responsive-panel?style=flat-square&logo=npm" alt="npm"/></a> | Responsive breakpoint'leri gerçek zamanlı görselleştiren ve test eden geliştirici aracı |
| [**react-api-forge**](https://www.npmjs.com/package/react-api-forge) | <a href="https://www.npmjs.com/package/react-api-forge"><img src="https://img.shields.io/npm/v/react-api-forge?style=flat-square&logo=npm" alt="npm"/></a> | Yükleme, hatalar ve iptal ile API çağrıları için type-safe React hook fabrikası |
| [**react-temporal**](https://www.npmjs.com/package/@xarlizard/react-temporal) | <a href="https://www.npmjs.com/package/@xarlizard/react-temporal"><img src="https://img.shields.io/npm/v/@xarlizard/react-temporal?style=flat-square&logo=npm" alt="npm"/></a> | JavaScript **Temporal API** kullanan tarih ve saat için React hook'ları |

<br/><br/>

<h2 align="center"><b>💻 Teknoloji Yığını</b></h2>
<div align="center">
<p>
...
<img src="https://img.shields.io/badge/tRPC-%232596BE.svg?style=for-the-badge&logo=tRPC&logoColor=white" alt="Badge Name"/>
...
<h2 align="center"><b>📊 GitHub İstatistikleri</b></h2>
<picture>
  <source
...
<h2 align="center"><b>🏆 GitHub Kupaları</b></h2>
<picture>
  <source
    media="(prefers-color-scheme: dark)"
...
<h2 align="center"><b>💰 Bağış yaparak bana yardımcı olabilirsiniz</b></h2>
<div align="center">
